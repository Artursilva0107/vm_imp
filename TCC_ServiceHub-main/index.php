  ...
  <main class="auth-form-side">
    <div class="auth-form-inner">
      ...
      <div class="social-btns">
        ...
        <!-- GitHub -->
        <a href="oauth/initiate.php?provider=github&tipo=<?= htmlspecialchars($tipo) ?>"
           class="btn-social" id="btnGithub">
        ...
        <!-- Microsoft -->
        <a href="oauth/initiate.php?provider=microsoft&tipo=<?= htmlspecialchars($tipo) ?>"
           class="btn-social" id="btnMicrosoft">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
